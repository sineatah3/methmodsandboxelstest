...
(() => {
    ...
    if (!elements.knife) {
        elements.knife = {
            ...
            behavior: behaviors.CURSOR || WALL,
            category: 'tools',
            state: 'solid',
            density: 7850,
            conduct: 0.8,
    ...
    // --------------------------------------------------------------------------
    // 14. ADD PLANT EXTRACTION REACTIONS
    // --------------------------------------------------------------------------
    ...
    console.log('✓ ChemResearch v2 COMPLETE - ALL RECIPES FIXED');
    console.log('='.repeat(70));
    console.log('');
    ...
    console.log('  ✓ cocaine + baking_soda → crack_slurry');
    console.log('  ✓ cocaine + water → cocaine_solution');
    console.log('  ✓ cocaine + sodium_hydroxide → cocaine_base');
    console.log('  ✓ cocaine_solution + baking_soda → crack_slurry');
    console.log('  ✓ crack_slurry (heat to 85°C) → crack');
    console.log('  ✓ methamphetamine + water → meth_solution');
    console.log('  ✓ mdma + water → mdma_solution');
    console.log('  ✓ heroin + water → heroin_solution');
    console.log('  ✓ morphine + acetic_anhydride → heroin_base');
    console.log('  ✓ psilocybin + water → psilocybin_tea');
    console.log('  ✓ mescaline + water → mescaline_tea');
    console.log('  ✓ codeine → morphine conversion');
    console.log('  ✓ psilocybin → psilocin conversion');
    console.log('  ✓ All plant + water/ethanol extractions');
    console.log('');
    console.log('🔪 HARVESTING TOOLS:');
    console.log('  ✓ Knife cursor tool - click plants to harvest');
    console.log('  ✓ Blade cursor tool - alternative harvester');
    console.log('  ✓ 18 plant types can be harvested');
    console.log('');
    ...
    console.log('');
    console.log('='.repeat(70));
    console.log('EDUCATIONAL USE ONLY - All reactions are now functional!');
    console.log('Total custom elements: 100+');
    console.log('='.repeat(70));
